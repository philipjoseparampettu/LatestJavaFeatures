	...
	private void startWatcher(String dirPath, String file) throws IOException {
		...
		while (true) {
			try {
				...
				/*
				 * While take() method wait for next change to happen and until it is blocked,
				 * poll() immediately check for change event. If nothing changed from last
				 * poll() call, it will return null. poll() method does not block the execution,
